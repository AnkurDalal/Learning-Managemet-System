  ...
  return (
    <div className="pd-14 px-8 md:px-0">
      ...
      <p className="md:text-base text-gray-500 mt-3">
        Hear from your learners as they share their journeys of
        transformation,success, and how our <br></br>platform has made a
        difference in their lives.
      </p>
      <div className="grid-auto-columns gap-8 mt-14">
